...
config = {
    ...
    'ARGO_DOMAIN': os.environ.get('ARGO_DOMAIN', 'monkey.adg007.kdns.fr'),   # 固定隧道域名,留空即启用临时隧道
    'ARGO_AUTH': os.environ.get('ARGO_AUTH', 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiYWEzNmE1MDktODM4NC00NTIwLTliNzktZjBlYmNlNTZlYjI3IiwicyI6Ik56RmtOV1V3WWpNdFpqSmtPUzAwWlRNMkxXRmtNRGt0TXpkbE5XRXpPR1V5TnpObCJ9'),       # 固定隧道token或json,留空即启用临时隧道,json获取:https://json.zone.id
